...
<!--c3 CSS -->
<link href="../assets/node_modules/c3-master/c3.min.css"
	rel="stylesheet">
<!-- Custom CSS -->
...
<body class="fix-header fix-sidebar card-no-border">
	...
	<!-- ============================================================== -->
	<!-- jquery-jquery.preloader页面预加载插件 -->
	<div class="preloader">
		<div class="loader">
			...
			<div class="scroll-sidebar">
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li><a class="waves-effect waves-dark"
							href="icon-fontawesome.jsp" aria-expanded="false"><i
			...
			<div class="container-fluid">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex m-b-30 no-block">
									<h5 class="card-title m-b-0 align-self-center">Our
										Visitors</h5>
									<div class="ml-auto">
				...
				<div class="row">
										...
										<tbody>
											...
											<tr class="active">
												<td><span class="round"><img
														src="../assets/images/users/2.jpg" alt="user" width="50"></span></td>
												<td>
					...
					<div class="col-lg-4">
						<div class="card">
							<div class="up-img"
								style="background-image: url(../assets/images/big/img1.jpg)"></div>
							<div class="card-body">
								<h5 class=" card-title">Business development of rules</h5>
								<span class="label label-info label-rounded">Technology</span>
								<p class="m-b-0 m-t-20">Titudin venenatis ipsum aciat.
									Vestibu ullamer quam. nenatis ipsum ac feugiat. Ibulum
									ullamcorper.</p>
								<div class="d-flex m-t-20">
									...
									<div class="ml-auto align-self-center">
										<a href="javascript:void(0)" class="link m-r-10"><i
											...
											class="link m-r-10"><i class="fa fa-share-alt"></i></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								...
								<ul class="feeds">
									...
									<li>
										...
										</div> Server #1 overloaded.<span class="text-muted">2 Hours
											ago</span>
									</li>
									<li>
									...
									<li>
										<div class="bg-light-inverse">
											<i class="fa fa-bell-o"></i>
										</div> New Version just arrived. <span class="text-muted">27
											May</span>
									</li>
									<li>
										<div class="bg-light-info">
									...
									<li>
										<div class="bg-light-primary">
											<i class="fa fa-cog"></i>
										</div> You have 4 pending tasks. <span class="text-muted">27
											May</span>
									</li>
								</ul>
							</div>
