						...
						<ul class="navbar-nav" style="float: right;">
							<li class="nav-item dropdown" style="">
								...
								<div class="dropdown-menu " style="min-width: 125px;">
									...
									<a class="dropdown-item" href="modperson.html">个人信息</a>
								</div>
							</li>
						</ul>
			...
			<aside class="left-sidebar">
				<div class="scroll-sidebar">
					<nav class="sidebar-nav">
						<ul id="sidebarnav">
							<li class="active">
								<a class="waves-effect waves-dark" href="fristshow.html" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">主页面</span></a>
							</li>
							<li>
								<a class="waves-effect waves-dark" href="usersShow.html" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">用户信息</span></a>
							</li>
							<li>
								<a class="waves-effect waves-dark" href="parkinfo.html" aria-expanded="false"><i class="fa fa-car"></i><span class="hide-menu">车库信息</span></a>
							</li>
							<li>
								<a class="waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-smile-o"></i><span class="hide-menu">车库操作</span></a>
							</li>
							<li>
