...
<script
	src="../assets/node_modules/bootstrap/js/bootstrap-datetimepicker.min.js"></script>
<script
	src="../assets/node_modules/bootstrap/js/bootstrap-datetimepicker.zh-CN.js"></script>
					...
					<ul class="navbar-nav" style="float: right;">
						<li class="nav-item dropdown" style=""><a
							...
							<div class="dropdown-menu " style="min-width: 125px;">
								<a class="dropdown-item" href="../logoutServlet">退出登录</a> <a
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						<li class="active"><a class="waves-effect waves-dark"
							href="modperson.jsp" aria-expanded="false"><i
								class="fa fa-address-card-o"></i><span class="hide-menu">个人信息</span></a></li>
								...
								<center class="m-t-30">
									...
									<h4 class="card-title m-t-10">
										<c:if test="${empty user}">
											管理员登录ID：
											<font color="red" id="admin_id">${admin.id}</font>
										</c:if>
										<c:if test="${empty admin}">
											用户登录ID：
											<font color="red" id="user_id">${user.id}</font>
										</c:if>
									</h4>
							...
							<div class="card-body">
								<form class="form-horizontal form-material">
									<c:if test="${empty admin}">
										...
										<div class="form-group">
											<label class="col-md-12"><h3 class="text-themecolor">车牌号码：</h3></label>
											<div class="col-md-12">
									...
									<c:if test="${empty user}">
										<div class="form-group">
											<label class="col-md-12"><h3 class="text-themecolor">管理员使用名：</h3></label>
											<div class="col-md-12">
												<input id="admin_name" readonly="readonly" type="text"
													placeholder="" class="form-control form-control-line">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-12"><h3 class="text-themecolor">管理员电话：</h3></label>
											<div class="col-md-12">
												<input id="admin_telephone" readonly="readonly" type="text"
													placeholder="" class="form-control form-control-line">
											</div>
										</div>
									</c:if>
			...
			$(function(){
				...
				if(typeof adminid != "undefined"){
					$.ajax({
						...
						type : "POST",
						success : function(result) {
							$("#admin_name").val(result.adminname);
							$("#admin_telephone").val(result.telephone);
						}
					});
				}
